module element_factory
  ...
  interface choose_element_type
    module procedure :: choose_element_type_by_int
    module procedure :: choose_element_type_by_name
  end interface choose_element_type

contains
  !=============================================================================
  subroutine choose_element_type_by_name(this, type, degree)
  ...
  end subroutine choose_element_type_by_name
  !=============================================================================
  subroutine choose_element_type_by_int(this, type, degree)
    class(ele_t), intent(inout), pointer :: this
  ...
  end subroutine choose_element_type_by_int
